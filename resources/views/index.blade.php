...
<main>
                    ...
                    <div class="overflow-hidden position-relative h-100">
                        <div class="slideshow-character position-absolute bottom-0 pos_right-center">
                            ...
                            <div class="character_markup type2">
                                <p class="text-uppercase font-sofia mark-grey-color animate animate_fade animate_btt animate_delay-10 mb-0">{{$slide->subtitle}}</p>
                            </div>
                        </div>
                        <div class="slideshow-text container position-absolute start-50 top-50 translate-middle">
                            <h6 class="text_dash text-uppercase fs-base fw-medium animate animate_fade animate_btt animate_delay-3">{{$slide->tagline}}</h6>
    ...
    <div class="container mw-1620 bg-white border-radius-10">
                                ...
                                <div class="swiper-slide product-card product-card_style3">
                                    <div class="pc__img-wrapper">
                                        <a href="{{route("shop.product", ["slug" => $product->slug])}}">
                                            <img loading="lazy" src="{{asset("uploads/products")}}/{{$product->image}}" width="258" height="313" alt="Cropped Faux leather Jacket" class="pc__img">
                                            @if ($product->images)
                                                <img loading="lazy" src="{{asset('uploads/products')}}/{{explode(", ",$product->images)[0]}}" width="258" height="313" alt="Cropped Faux leather Jacket" class="pc__img pc__img-second">
                                            @endif
                                        </a>
                                    </div>

                                    <div class="pc__info position-relative">
                                        <h6 class="pc__title"><a href="{{route('shop.product', ["slug" => $product->slug])}}">Cropped Faux Leather Jacket</a></h6>
        ...
        <div div class="mb-3 mb-xl-5 pt-1 pb-4"></div>
            ...
            @foreach ($fProducts as $fProduct)
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="product-card product-card_style3 mb-3 mb-md-4 mb-xxl-5">
                        <div class="pc__img-wrapper">
                            <a href="{{route('shop.product', ['slug' => $fProduct->slug])}}">
                        ...
                        <div class="pc__info position-relative">
                            <h6 class="pc__title"><a href="{{route('shop.product', ['slug' => $fProduct->slug])}}">Kirby T-Shirt</a></h6>
                            <div class="product-card__price d-flex align-items-center">
                                @if ($fProduct->sale_price > 0)
                                    <span class="money price-old">${{$fProduct->sale_price}}</span>
                                @endif
