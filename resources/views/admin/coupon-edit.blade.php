    ...
    <div class="main-content-wrap">
        ...
        <div class="wg-box">
            <form class="form-new-product form-style-1" method="POST" action="{{route('admin.coupon.update')}}">
                ...
                @error("code") <p class="alert alert-danger text center">{{$message}}</p> @enderror
                    ...
                    <div class="select flex-grow">
                        <select class="" name="type">
                            ...
                            @foreach ($typeOptions as $opt) 
                                <option {{$coupon->type === $opt ? "selected" : ""}} value="{{$opt}}">{{$opt}}</option>
                            @endforeach
                        </select>
                    </div>
                </fieldset>
                @error("type") <p class="alert alert-danger text center">{{$message}}</p> @enderror
                <fieldset class="name">
                ...
                @error("value") <p class="alert alert-danger text center">{{$message}}</p> @enderror
                <fieldset class="name">
                ...
                @error("cart_value") <p class="alert alert-danger text center">{{$message}}</p> @enderror
                <fieldset class="name">
                ...
                @error("expiry_date") <p class="alert alert-danger text center">{{$message}}</p> @enderror
