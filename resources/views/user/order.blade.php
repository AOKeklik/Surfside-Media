                        ...
                        @foreach ($orderItems as $orderItem)
                            <tr>
                                <td class="pname">
                                    ...
                                    <div class="name">
                                        <span target="_blank" class="body-title-2">{{$orderItem->product->name}}</span>
                                    </div>
                                </td>
                                ...
                                <td class="text-center">
                                    {{$orderItem->results == 0 ? "no" : "yes"}}
                                </td>
                                <td class="text-center">
                                <a href="{{route('shop.product', ["slug" => $orderItem->product->slug])}}" target="_blank">
                    ...
                    <table class="table table-striped table-bordered table-transaction">
                        <tbody>
                            ...
                            <tr>
                                <th>Order Date</th>
                                <td>
                                    @if ($transaction->status === "appreved")
                ...
                @if ($order->status === "ordered")
                    <div class="wg-box mt-5 text-right">
                        <form action="{{route("user.order.canceled")}}" method="POST">
                            ...
                            <button type="button" onclick="handlerCanceledClick(event)" class="btn btn-danger">Cancel Order</button>
                        </form>
                    </div>
                @endif
            </div>
...
@push("scripts")
<script>
    function handlerCanceledClick (e) {
